...
const FAQ = {
    ...
    "h1": {
		ru: "Ссылки на группы ВК",
		en: "Links to VK groups",
		ch: "VK组的连结",
		ar: "روابط لمجموعات فك",
	},
    "p1": {
		ru: "Союз студентов УрФУ",
		en: "UrFU Students' Union",
		ch: "UrFU Students' Union",
		ar: "اتحاد طلاب أورفو",
	},
    "p2": {
		ru: "Уральский федеральный университет | УрФУ",
		en: "Ural Federal University | UrFU",
		ch: "乌拉尔联邦大学/UrFU",
		ar: "جامعة الأورال الاتحادية / أورفو",
	},
    "p3": {
		ru: "Новости радиофака | ИРИТ-РТФ УрФУ",
		en: "Radiofak News | IRIT-RTF UrFU",
		ch: "Radiofak新闻/IRIT-RTF UrFU",
		ar: "أخبار راديوفاك / إيريت-رتف أورفو",
	},
    "p4": {
		ru: "СОЮЗ СТУДЕНТОВ ИРИТ-РТФ УрФУ",
		en: "UNION OF STUDENTS OF IRIT-RTF UrFU",
		ch: "Irit-RTF UrFU学生联盟",
		ar: "اتحاد طلاب إريت-رتف أورفو",
	},
    "p5": {
		ru: "Проекты 23-24 (ОПД 1 курс)",
		en: "Projects 23-24 (OPD 1st year)",
		ch: "项目23-24(OPD第一年)",
		ar: "مشاريع 23-24 (العيادات الخارجية 1 سنة)",
	},
    "p6": {
		ru: "Первый курс ИОТ ИРИТ-РТФ УрФу",
		en: "First year and FROM IRIT-RTF UrFU",
		ch: "第一年和IRIT-RTF UrFU",
		ar: "السنة الأولى ومن إريت-رتف أورفو",
	},
    "h2": {
		ru: "Ссылки на telegram каналы",
		en: "Links to telegram channels",
		ch: "电报频道的链接",
    ...
    "p8": {
		ru: "Итак, у вас Онлайн в УрФУ",
		en: "So, you have Online in UrFU",
		ch: "所以，你在UrFU在线",
		ar:"لذلك ، لديك على الانترنت في أورفو",
	},
    "p9": {
		ru: "Новости радиофака",
		en: "Radiofak News ",
		ch: "Radiofak新闻",
		ar:"راديوفاك الأخبار",
	},
